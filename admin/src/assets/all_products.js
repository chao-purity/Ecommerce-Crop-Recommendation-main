...
let all_products = [
  {
      ...
      new_price: 1.25,
      // Varieties
      varieties: ["Seuri", "Millionnaire", "Gifu", "African Black", "Uzuri"],
      // Tags
      tags: "Season (cool season), Climate (temperate, subtropical) , Sun requirements (full sun) , Water requirements (moderate) , Maturity time (50-60 days) , Flavor profile (slightly bitter) , Culinary uses (salads, stir-fries, soups)"
    },
    {
      id: 2,
      ...
      new_price: 1.75,
      // Varieties
      varieties: ["Sagaa", "Red spinach", "Victoria spinach", "New Zealand spinach", " Malabar spinach"],
      // Tags
      tags: "Season (cool season) , Climate (tropical, subtropical) , Sun requirements (full sun to partial shade) , Water requirements (moderate) , Maturity time (30-40 days) , Flavor profile (slightly bitter) , Culinary uses (salads, stir-fries, soups)"
    },
    {
      id: 3,
      name: "Cabbage",
      ...
      new_price: 2.00,
      // Varieties
      varieties: ["Green Cabbage (Brassica oleracea var. capitata)", "Red Cabbage (Brassica oleracea var. capitata f. rubra)", "Savoy Cabbage (Brassica oleracea var. sabauda)", "Chinese Cabbage (Brassica rapa subsp. pekinensis)", "Kale (Brassica oleracea var. acephala)"],
      // Tags
      tags: "Season (cool season) , Climate (temperate, cool) , Sun requirements (full sun) , Water requirements (moderate) , Maturity time (60-90 days) , Flavor profile (varies by type) , Culinary uses (salads, stir-fries, sauerkraut)"
    },
    {
      id: 4,
      name: "Tomatoes",
      ...
      new_price: 2.75,
      // Varieties
      varieties: ["Roma tomatoes", "Beefsteak tomatoes", "Cherry tomatoes", "Heirloom tomatoes", "Plum tomatoes"],
      // Tags
      tags: "Season (warm season) , Climate (warm, temperate) , Sun requirements (full sun) , Water requirements (moderate) , Maturity time (50-80 days) , Flavor profile (varies by type) , Culinary uses (salads, sauces, canning)"
    },
    {
      id: 5,
      name: "Potatoes",
      ...
      category: "Roots & Tubers", // Corrected category
      image: p5_img,
      old_price: 1.75,
      new_price: 1.50,
      // Varieties
      varieties: ["Irish potatoes", "Sweet potatoes", "Purple potatoes", "Red potatoes", "Fingerling potatoes"],
      // Tags
      tags: "Season (cool season) , Climate (temperate, cool) , Sun requirements (full sun) , Water requirements (moderate) , Maturity time (60-90 days) , Flavor profile (starchy) , Culinary uses (baking, roasting, mashing, frying)"
    },
  {
    id: 6,
    name: "Sweet potatoes",
    ...
    category: "Vegetables", // Corrected category
    image: p6_img,
    old_price: 1.75,
    new_price: 1.50,
    // Varieties (already under Vegetables)
  },
  {
    id: 7,
    name: "Onions",
    description: "Bulb vegetables with layered skins, characterized by their pungent flavor and long storage life",
    category: "vegetables", // Minor typo correction
    image: p7_img,
    old_price: 1.75,
    new_price: 1.50,
    // Varieties
    varieties: ["Yellow onions", "Red onions", "White onions", "Green onions", "Shallots"]
  },
  {
    id: 8,
    name: "Garlic",
    ...
    new_price: 1.50,
    // Varieties
    varieties: ["Elephant garlic", "Creole garlic", "Softneck garlic", "Purple garlic", "Artichoke garlic"]
  },
      {
        id: 9,
