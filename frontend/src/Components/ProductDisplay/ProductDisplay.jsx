...
export const ProductDisplay = (props) => {
  ...
  return (
    <div className='productdisplay'>
        ...
        <select>
            <option value="1">{product.varieties[1]}</option>
            <option value="2">{product.varieties[2]}</option>
            <option value="3">{product.varieties[3]}</option>
            <option value="4">{product.varieties[4]}</option>
            <option value="5">{product.varieties[5]}</option>
        </select>
    </div>
        </div>
